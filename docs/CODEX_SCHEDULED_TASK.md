...
It capitalizes only an empty fund, verifies the ledger, requires today's UTC input and a complete brain journal, applies one atomic fake-money cycle, and verifies the full history again. It does not invoke the older broker-aware autonomy service.
